...
<div id="container" class="min-h-[100vh] relative">
    <div id="header">
        <div class="" style="">
            <div class="">
                <header class="bg-neutral-800 w-[100vw]">
                    <nav class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" aria-label="Top">
                        <div
                            class="w-full py-6 flex items-center justify-between border-b border-grey-700 lg:border-none">
                            <div class="flex items-center">
                                <a href="#"> <span class="sr-only">UCiputra</span> <img
                                        class="h-10 w-auto"
                                        src="https://dieng.blob.core.windows.net/webmaster/2021/09/LOGO-UC-PANJANG-FIX-SEP-2021-03.png"
                                        alt="Universitas Ciputra"> </a>
                                <div class="hidden ml-10 space-x-8 lg:block">
                                    <a href="/kanjuruhan/"
                                       class="text-base font-medium text-white hover:text-indigo-50">Kanjuruhan </a>
                                    <a href="about.php"
                                       class="text-base font-medium text-white hover:text-indigo-50">About </a>
                                    <a href="#" class="hidden font-medium text-white hover:text-indigo-50">Docs </a>
                                    <a href="#"
                                       class="hidden font-medium text-white hover:text-indigo-50">Company </a>
                                </div>
                            </div>

                        </div>
                        <div class="py-4 flex flex-wrap justify-center space-x-6 lg:hidden"><a href="/kanjuruhan/"
                                                                                               class="text-base font-medium text-white hover:text-indigo-50">
                                Kanjuruhan </a> <a href="about.php"
                                                   class="text-base font-medium text-white hover:text-indigo-50">
                                About </a> <a href="#"
                                              class="hidden text-base font-medium text-white hover:text-indigo-50">
                                Docs </a> <a
                                href="#" class="hidden text-base font-medium text-white hover:text-indigo-50">
                                Company </a>
                        </div>
                    </nav>
                </header>
    ...
    <div id="footer" class="absolute bottom-0 w-[100vw] h-[60px]">
        <div class="" style="">
            <footer class="bg-neutral-800" aria-labelledby="footer-heading"><h2 id="footer-heading" class="sr-only">
                    Footer</h2>
                <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">

                    <p class="mt-2 text-base text-gray-400 md:mt-0 md:order-1"> Laman ini dibuat untuk pemenuhan AFL
                    ...
                    <div class="mt-8 border-t border-gray-700 pt-8 md:flex md:items-center md:justify-between">
                        ...
                        <p class="mt-8 text-base text-gray-400 md:mt-0 md:order-1"> © 2022 kevinchr.com | All rights
                            reserved. <br>Information & Multimedia Technology <br>Ciputra University </p>
                    </div>
                </div>
            </footer>
        </div>
